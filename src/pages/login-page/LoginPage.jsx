      ...
      <div className="w-[100%] h-[100%] flex justify-center items-center">
        <div className="flex flex-col gap-11 p-[3%] border rounded-md border-gray-700">
          ...
          <div className="flex flex-col gap-3">
            <button
              className={`w-[100%] h-10 ${false === isSubmitDisabled ? 'bg-gray-800' : 'bg-slate-400'} border rounded-md text-white hover:bg-slate-400`}
            ...
            <p className="self-start">{"vous n'aveez pas de compte ?"}</p>
            <Link
              to={"/sinup"}
              className="text-sky-600 self-start border-b hover:text-sky-300"
            >
              Inscrivez vous
            </Link>
          </div>
